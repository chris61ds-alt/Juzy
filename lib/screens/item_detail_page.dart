    ...
    return Scaffold(
      ...
      body: CustomScrollView(slivers: [
          ...
          SliverToBoxAdapter(child: Center(child: ConstrainedBox(constraints: const BoxConstraints(maxWidth: 700), child: Padding(padding: const EdgeInsets.symmetric(horizontal: 20), child: Column(children: [
                      ...
                      StaggeredSlide(delay: 400, child: FittedBox(fit: BoxFit.scaleDown, child: RollingNumber(value: widget.item.price, style: TextStyle(fontSize: 42, fontWeight: FontWeight.w900, color: priceColor), suffix: " €"))),
